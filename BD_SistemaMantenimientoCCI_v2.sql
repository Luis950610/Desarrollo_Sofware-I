...
/*  ***************************************************************************************** 
	...
	*****************************************************************************************  */
	...
	EXEC  sp_addtype  TCodCursoActivo, 'varchar(12)','NOT NULL' -- Grupo 05
...
/* ================== PROCEDIMIENTOS ALMACENADOS PARA LA TABLA BOLETA ================== */
	...
	/* ---------------- Procedimiento para Modificar Grupo --------------- */
	...
	as
		select C.Codigo_CursoActivo,C.Grupo,Nombre,Tema,Tipo,HorasxSemana,DescripcionHorario=C.Dias+':'+C.Hora,C.Periodo,C.Año
			...
			on V.CodCurso=C.Codigo_CursoActivo and C.Grupo=C.Grupo and V.Periodo=C.Periodo and C.Año=V.Año
	...
	/* ---------------- Procedimiento para Buscar Docente por Apellido/Nombre --------------- */
	...
	@cadena varchar(100)
	as
		select T.CodDocente, Docentes_Disponibles=Apellidos+' '+Nombres
		...
		select CodDocente
			from CargaAcademica CA inner join CursoActivo C 
			on CA.CodCurso=C.CodCurso and CA.Grupo=C.Grupo and CA.Periodo=C.Periodo and CA.Año=C.Año
			where CA.Periodo=@Periodo and C.Año=@Año and Hora=@Hora and Dias=@Dias)T inner join Docente D
			on T.CodDocente=D.CodDocente
